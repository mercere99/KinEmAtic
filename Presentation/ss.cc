...
extern "C" int emkMain()
{
  ...
  show.Pause();
  emk::Tween & temp_tween = show.BuildTween("image_move", show.Text(), 3).SetXY( show(0.8, 0.88) ).SetScaleXY(5.0, 5.0).SetRotation(900).SetEasing(emk::Tween::Linear);
  show.SetAction( temp_tween );
